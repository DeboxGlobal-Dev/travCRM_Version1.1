...
use App\Models\Master\ExpenseHeadMaster;

class ExpenseHeadMasterController extends Controller
{
    public function index(Request $request){
        ...
        $posts = ExpenseHeadMaster::when($Search, function ($query) use ($Search) {
        ...
        try{
            ...
            if($id == '') {
                ...
                $businessvalidation =array(
                    'ExpenseHead' => 'required|unique:'._DB_.'.'._EXPENSE_HEAD_MASTER.',ExpenseHead',
                );
                ...
                if($validatordata->fails()){
                 ...
                 $savedata = ExpenseHeadMaster::create([
                ...
                $id = $request->input('id');
                $edit = ExpenseHeadMaster::find($id);
