...
use App\Models\Master\OperationRestriction;

class OperationRestrictionController extends Controller
{
    public function index(Request $request){
        ...
        $posts = OperationRestriction::when($Search, function ($query) use ($Search) {
        ...
        try{
            ...
            if($id == '') {
                ...
                if($validatordata->fails()){
                 ...
                 $savedata = OperationRestriction::create([
                ...
                $id = $request->input('id');
                $edit = OperationRestriction::find($id);
