...
Route::post('/itineraryrequirementmasterlist',[ItineraryRequirementController::class,'index']);
Route::post('/addupdateitineraryrequirementmaster',[ItineraryRequirementController::class,'store']);
//===========================================END HERE========================================
